...
#cluster
scp dzung@cluster:~/io_benchmark/export/atop_mem.log export/cluster/
scp dzung@cluster:~/io_benchmark/export/timestamps_pipeline.csv export/cluster/
scp dzung@cluster:~/io_benchmark/export/*.dsk.gz export/cluster/